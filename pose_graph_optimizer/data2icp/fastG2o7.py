...
def writeG2O(X_meta, Y_meta, THETA_meta, poses, iPoses, icpId):
	...
	g2o.write("\n")
	info_mat = "1400.0 0.0 0.0 1400.0 0.0 1400.0"
...
if __name__ == '__main__':
	...
	# print(poses.shape, iPoses.shape, icpId.shape)

	writeG2O(X, Y, THETA, poses, iPoses, icpId)
